...
#include "../../clientserver/Client/calculatorInterface.h"
...
QT_MOC_LITERAL(1, 39, 6), // "divide"
QT_MOC_LITERAL(2, 46, 25), // "QDBusPendingReply<double>"
QT_MOC_LITERAL(3, 72, 0), // ""
QT_MOC_LITERAL(4, 73, 8), // "divident"
QT_MOC_LITERAL(5, 82, 7), // "divisor"
QT_MOC_LITERAL(6, 90, 8), // "multiply"
QT_MOC_LITERAL(7, 99, 7), // "factor1"
QT_MOC_LITERAL(8, 107, 7) // "factor2"

    },
    "ComBlikoonCalculatorInterfaceInterface\0"
    "divide\0QDBusPendingReply<double>\0\0"
...
static const uint qt_meta_data_ComBlikoonCalculatorInterfaceInterface[] = {
 ...
 // slots: parameters
    ...
    0x80000000 | 2, QMetaType::Double, QMetaType::Double,    7,    8,
...
void ComBlikoonCalculatorInterfaceInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { QDBusPendingReply<double> _r = _t->divide((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2])));
            if (_a[0]) *reinterpret_cast< QDBusPendingReply<double>*>(_a[0]) = std::move(_r); }  break;
        case 1: { QDBusPendingReply<double> _r = _t->multiply((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2])));
            if (_a[0]) *reinterpret_cast< QDBusPendingReply<double>*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
    }
